...
############################################################################
#train_listfname = '../train_list_info.csv.gz'
#test_listfname = '../train_list_info_title1songs_low50.csv.gz'
...
#util.get_train_test_1(train_listfname, test_listfname, songfname, nrows, testrows, threshould)
...
r, scores = cp.RecommendToUsers(test_users_v, u2s_v, test_u2s_v)
r = r.astype(np.int64)
scores = scores.astype(np.float32)
print("The number of list %s"%(len(r)))
print("the number of each list %s"%(len(r[0])))
...
test.to_csv('cf2xgb_pred1_v3.csv.gz', index=False, compression='gzip')
