...
readfile = './cf2xgb_pred1_v5.csv.gz'
savefile = 'cf2xgb_10_pred1_v5.csv.gz'
...
#usecols = ['pid', 'track_uri', 'cf_prob', 'album_uri', 'artist_uri', 'name_sim', 
...
#df_pos = result_test[['pid', 'pos_songs']]
#gc.collect()
...
#
#np.savetxt('lgb2submit_v5.txt', res, delimiter=',')
