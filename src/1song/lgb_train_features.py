...
readfile = 'cf2xgb_1.csv.gz'
savefile_train = 'cf2xgb_1_train.csv.gz'
savefile_test = 'cf2xgb_1_test.csv.gz'
...
''' add similarity '''
w2v_train.build_track_w2v(w2v_test_pids)
w2v_train.build_album_w2v(w2v_test_pids)
w2v_train.build_artist_w2v(w2v_test_pids)
