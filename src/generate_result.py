...
os.system("python auto_cf_test_submission_25_order.py")

os.chdir('../25songs_shuffle')
os.system("python auto_cf_test_submission_25_shuffle.py")

os.chdir('../100songs_order')
os.system("python auto_cf_test_submission_100_order.py")

os.chdir('../100songs_order')
os.system("python auto_cf_test_submission_100_shuffle.py")
