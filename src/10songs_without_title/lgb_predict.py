...
savepath = '../submit/'
filename = 'cf2xgb_10_pred1_v'+version+'.csv.gz'
usecols = ['track_uri', 'cf_prob', 'album_uri', 'artist_uri',  
           'cf_rlt_prob', 'w2v_track_sim', 'w2v_album_sim',
           'w2v_artist_sim']
model_name = 'model12_0630.txt'
nrows = None
...
for tup in df.itertuples():
    ...
    i += 1
savefile = 'lgb2submit_v'+str(version)+'.txt'
np.savetxt(os.path.join(savepath, savefile), res, delimiter=',')
