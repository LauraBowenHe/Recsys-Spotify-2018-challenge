...
readfile = '../10songs_with_title/cf2xgb_10.csv.gz'
savefile_train = '../10songs_with_title/cf2xgb_10_train.csv.gz'
savefile_test = '../10songs_with_title/cf2xgb_10_test.csv.gz'
