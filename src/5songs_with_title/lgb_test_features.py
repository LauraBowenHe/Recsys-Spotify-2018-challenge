...
readfile = './cf2xgb_pred1_v3.csv.gz'
savefile = 'cf2xgb_5_pred1_v3.csv.gz'
...
start_time = time.time()
print("calculate word2vec similarity for track, artist, album, it takes a long time, like 1.5h.\n Please be patient...")
result_test = add_w2v_sim(result_test)
print("track multiple w2v similarity --- %s seconds ---" % (time.time() - start_time))
